...
scheduler: php artisan config:cache && php artisan migrate --force && php artisan storage:link && while true; do php artisan schedule:run --verbose --no-interaction & sleep 60; done
